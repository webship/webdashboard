...
Dashboards built with Display Builder: configuration entities, per-user personalization, dashboard items, charts and embedded views. Part of Webship: the UI Suite UIkit theme (UIkit and HTMX) on top of Drupal and Display Builder.
